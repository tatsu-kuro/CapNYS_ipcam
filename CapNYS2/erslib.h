...
int ers_initdone[ERSLIBMAXPORT]={0};	//0で初期化
...
//	ERS_Config(n,ERS_9600|ERS_1|ERS_NO|ERS_8|ERS_X_N|ERS_CTS_N|ERS_DSR_N|ERS_DTR_Y|ERS_RTS_Y);
	ERS_Config(n,ERS_115200|ERS_1|ERS_NO|ERS_8|ERS_X_N|ERS_CTS_N|ERS_DSR_N|ERS_DTR_Y|ERS_RTS_Y);
...
int ERS_OpenY(int n, int recv_size, int send_size)
{
//	wchar_t comname[11];
	char comname[11];
...
int ERS_OpenN(int n, int recv_size, int send_size)
{
//	wchar_t comname[11];
	char comname[11];
...
//	SetupComm(ERSHCOMn,recv_size,send_size);
	...
	//通信のデフォルト設定
//	ERS_Config(n,ERS_9600|ERS_1|ERS_NO|ERS_8|ERS_X_N|ERS_CTS_N|ERS_DSR_N|ERS_DTR_Y|ERS_RTS_Y);
	ERS_Config(n,ERS_115200|ERS_1|ERS_NO|ERS_8|ERS_X_N|ERS_CTS_N|ERS_DSR_N|ERS_DTR_N|ERS_RTS_Y);
	ERS_RecvTimeOut(n,1000);
	ERS_SendTimeOut(n,1000);
	return 0;
}//	#endif
